...
- **JS Mode (Beta)** - No backend needed, uses browser File System API to access local filesystem
...
- **Animation optimization** — Easing changed from easeOutQuad to easeOutCubic; 全新收起动画实现
